...
train_data = "/workspace/dataset/blademaster/juggernaut/juggdet/juggdet_0503/Cache/juggdet_0503_train_lmdb"
...
job_name = "juggdet_v4.1_refinedet_vgg16_{}_ft".format(resize)
# The name of the model. Modify it if you want.
# model_name = "VOC0712Plus_{}".format(job_name)
model_name = "juggdet_v4.1"

# Directory which stores the model .prototxt file.
# save_dir = "models/VGGNet/VOC0712Plus/{}".format(job_name)
# save_dir = "/workspace/RefineDet/data/juggdet/vgg-16-reduce-512"
save_dir = "tmp/"
# Directory which stores the snapshot of models.
# snapshot_dir = "models/VGGNet/VOC0712Plus/{}".format(job_name)
snapshot_dir = "/workspace/blademaster/model/juggdet_v4.1_refinedet_vgg_16_reduce_512"
# Directory which stores the job script and log file.
# job_dir = "jobs/VGGNet/VOC0712Plus/{}".format(job_name)
job_dir = "/workspace/RefineDet/data/juggdet/vgg-16-reduce-512"
# Directory which stores the detection results.
# output_result_dir = "{}/data/RefineDet/pascal/VOCdevkit/results/VOC2012/{}/Main".format(os.environ['HOME'], job_name)
output_result_dir = "/workspace/RefineDet/data/juggdet/vgg-16-reduce-512/result"
...
pretrain_model = "/workspace/RefineDet/data/juggdet/vgg-16-reduce-512/VGG_ILSVRC_16_layers_fc_reduced.caffemodel"

# Stores LabelMapItem.
label_map_file = "/workspace/RefineDet/data/juggdet/labelmap_juggdet.prototxt"
